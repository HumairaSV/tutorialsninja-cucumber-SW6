Feature: Laptops And Notebooks Page
  ...
  Scenario: Verify that the user is able to place order successfully
    ...
    And   I enter first name "Testerhv4"
    And   I enter last name "Cocomelon"
    And   I enter email "Testerhv2@gmail.com"
    And   I enter phone no "07889966541"
    And   I enter Address "House 204"
    And   I enter city name "Manchester"
    And   I enter postcode "M12 9AL"
    And   I select Country "United Kingdom" from drop down
    And   I select Region "Greater Manchester" from drop down
